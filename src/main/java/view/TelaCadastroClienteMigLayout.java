...
public class TelaCadastroClienteMigLayout extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaCadastroClienteMigLayout frame = new TelaCadastroClienteMigLayout();
	 ...
	 * Create the frame.
	 */
	public TelaCadastroClienteMigLayout() {
